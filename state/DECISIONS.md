...
The authoritative decision register is [DECISIONS.md](../DECISIONS.md). S00A froze only the engineering workspace decision; research interfaces and algorithms remain UNDECIDED.

S00B audit evidence: `reports/data_audit/DATA_AUDIT.md` and `docs/DATA_CONTRACT_EVIDENCE.md`. D-S00B-01 through D-S00B-04 were preserved. No research definition was frozen by the execution agent. `PROPOSED_RESEARCH_CHANGE: NONE`.
...
## S04-IO-RECOVERY-01 terminal decision — 2026-09-25

VERIFIED: scoped GOV-SOL-CLOSEOUT-01 and S04-IO-RECOVERY-01 are now CONSUMED after one reviewed, committed Attachment4 aligned-only Gate A run. Fixed M2 seed17 epoch2, TRAIN scaler and V1 unchanged; new training fits 0. Attachment3 cannot be inferred because all 30 official aligned PKLs lack continuous 50×768 text; official schema clarification required. Attachment4 has 20 private PARTIAL rows with feature indices and null timestamps; Gate B source mapping remains UNVERIFIED. This does not reopen S01/S02/S03 or authorize test, further special access, training, Release or contest upload. Evidence: reports/s04_io/FINAL_STATUS.json and docs/research/S04/CLOSEOUT.md. D-DATA-01..07 unchanged.

## S04-CLARIFY-02 scoped status — 2026-09-25

Current user plus three visually checked contest replies authorize aligned-only output, Attachment3 text extraction as preprocessing and reproducible estimated material mapping. Clean TRAIN/VALID BERT replay passes a documented backend envelope, but Attachment3's 131 in-support ID-100 positions have no verified corresponding continuous-feature/missingness rule; CSV not generated and independent new pipeline would require future training authority. The prior 20 Attachment4 predictions are unchanged; text-token and continuous-text replay pass all 20, acoustic mapping is estimated for 12 and text-only for 8, with 0 human checks. M2/scaler/V1, data contracts, old evidence and historical claims unchanged; new fits 0. Evidence: reports/s04_clarify_02/RESULT.json. S04-CLARIFY-02 is consumed after this task.
